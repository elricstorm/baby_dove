...
5. Edit your mainapp gemfile and +add/substract+ the following:
...
7. Delete all javascript files in your main app minus +application.js+ and +rails.js+.

Now then, go into your "mainapp".

8. cd mainapp
9. Type [+bundle install+] without the brackets and hit enter.
10. After bundling is finished type [rails generate baby_dove] without the brackets and hit enter.
