...
application.  I've been working on a very deeply coded forum software called +Ki-Rin+ and thought it would
...
5. Edit your mainapp gemfile and +add/substract+ the following, and then save it:
...
1. Delete all javascript files in your main app minus +application.js+ and +rails.js+.

Now then, go into your "mainapp".

2. cd mainapp
3. Type +bundle install+ and hit enter.
4. After bundling is finished type +rails generate baby_dove+ and hit enter.
...
about engines or just want to chat, contact me at +jdezenzio@gmail.com+.  I look forward to hearing
from you!